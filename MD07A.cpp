...
MD07A::MD07A(int DirectionPin, int PWMHPin, int ResetPin){
...
//  --------------------------------------------------------------------------
void MD07A::Rotate(bool direction, float degrees){
  int timeDelay;
  // Determine direction
  digitalWrite(pin_dir, direction);

  // Determine time to spin
  timeDelay = MS_PER_RAD * DegToRad(degrees);
...
//  --------------------------------------------------------------------------
void MD07A::Rotate(bool direction, float degrees, int dutyCycle){
...
void MD07A::IndicatorLED(bool enable){
